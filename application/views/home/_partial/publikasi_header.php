  ...
  <header id="header" class="header-fixed">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        ...
        <a href="<?= base_url() ?>home/" class="scrollto"><img src="<?= base_url() ?>assets/home/img/logo.png" alt="" title=""></a>
      </div>

            <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li><a href="<?= base_url() ?>home/#intro"><i class="fa fa-home"></i> Home</a></li>
          <li><a href="<?= base_url() ?>home/#ttgAplikasi"><i class="fa fa-info-circle"></i> Tentang Aplikasi</a></li>
          <li><a href="<?= base_url() ?>home/#layanan"><i class="fa fa-cogs"></i> Layanan</a></li>
          <li class="menu-active"><a href="<?= base_url() ?>home/#publikasi"><i class="fa fa-chart-bar"></i> Publikasi</a></li>
