...
<div class="container-fluid">
	<div class="row">		
      <div class="col">
      	<h3>List Penduduk
      	<a href="<?= base_url('admin/tambah_penduduk') ?>" class="btn btn-primary float-right mb-3"><i class="fas fa-plus"></i> Tambah data</a>
      </h3><hr>
      <?= $this->session->flashdata('message'); ?>
      	<!-- <?= $sql; ?> -->
  		<form action="<?= base_url() ?>admin/data_desa" method="POST">		      			
	      	...
	      	<div class="row m-3 p-3 bg-white">
				...
				<div class="col-md-6">
					...
					<a href="<?= base_url('admin/data_desa') ?>" class="btn btn-default float-right mr-3 table-bordered" disabled><i class="fa fa-retweet"></i> Reset</a>
				</div>
	      	</div>
  		</form>
      	<br><br>
